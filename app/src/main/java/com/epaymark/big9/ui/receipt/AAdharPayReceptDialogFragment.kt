...
import com.epaymark.epay.databinding.FragmentAadharWithdrawReceptDialogBinding


class AAdharPayReceptDialogFragment(val callBack: CallBack) : BaseCenterSheetFragment() {
    lateinit var binding: FragmentAadharWithdrawReceptDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_aadhar_withdraw_recept_dialog, container, false)
