...
class BankListBottom2SheetDialog(val callBack: CallBack, val bankList:ArrayList<BankListModel2>) : BaseBottomSheetFragment() {
            ...
            binding.apply {
                recycleViewPaymentRequest.apply {
                   /* bankList.add(BankListModel(R.drawable.axix_bank_logo,"AXIX BANK","A/C:91022112121212","IFSC:UTIB0000669"))
                    ...
                    bankList.add(BankListModel(R.drawable.axix_bank_logo,"AXIX BANK","A/C:91022112121212","IFSC:UTIB0000669"))
                    bankList.add(BankListModel(R.drawable.axix_bank_logo,"AXIX BANK","A/C:91022112121212","IFSC:UTIB0000669"))*/
                    adapter= BankListAdapter2(bankList, object : CallBack4 {
