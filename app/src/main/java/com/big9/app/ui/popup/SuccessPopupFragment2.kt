...
import com.big9.app.databinding.FragmentSuccessPopup2Binding
...
class SuccessPopupFragment2(val callBack4: CallBack4) : PopUpFragment() {
    lateinit var binding: FragmentSuccessPopup2Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_success_popup2, container, false)
