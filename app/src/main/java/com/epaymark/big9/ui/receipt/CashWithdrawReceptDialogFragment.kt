...
import com.epaymark.epay.databinding.FragmentCashWithdrawReceptDialogBinding


class CashWithdrawReceptDialogFragment(val callBack: CallBack) : BaseCenterSheetFragment() {
